...
export const MODEL_POLICIES: Record<ModelTaskType, ModelPolicy> = {
  classification: {
    ...
    required_capabilities: ["text_generation", "structured_json"],
    minimum_quality_tier: "baseline",
    fallback_candidates: [luna],
  ...
  legal_research: {
    ...
    requires_explicit_cost_cap: true,
    fallback_mode: "optional",
    required_capabilities: ["text_generation", "structured_json", "long_context"],
    minimum_quality_tier: "standard",
    fallback_candidates: [terra],
    escalation_candidates: [],
    requires_human_review: false,
  },
  generation: {
