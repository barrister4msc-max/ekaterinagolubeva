-- Pin the recovered, reproducible OCR transcript for the already hash-verified
-- VAS №53 PDF. This changes neither source scope nor metadata/admission flags;
-- it only replaces the private RPC definition.
  ...
  loop
    ...
    case v_key
      ...
      when 'ru:court_practice:plenum_vas:53:2006-10-12' then
        ...
        v_expected_hashes := array[
          '2d9959f5ed0ce77860e4de349330ddcc5d103ac9dfc839e65783a24862f87541','b232401c49bfb68f2f2787a2a34a7a221a6de55f71a0a640c978c6d9f0b44d53','4fddb7e1efd0b8b4aa4bff9a4812aeb741e39cde902ad776bf26b5723da40e27','54c9ca14a2e5e6ff6422cf10da176932214036fab4d54f8bca615b2f0640daaf','9e961a9a66139a65ce4f9a241308070c66d5d147df7408a421ac3c25ee23f058','50cdaa4f6a56ff78a0f4405c7d4176d1ee7dc5065a7fc5d2506ed8c1b801e8b9'
        ];
        ...
        v_metadata := jsonb_build_object(
          ...
          'text_sha256', 'bcd100705214768ec63a91401359e954277a97ad04f47a63bc66f41edb62d96e',
