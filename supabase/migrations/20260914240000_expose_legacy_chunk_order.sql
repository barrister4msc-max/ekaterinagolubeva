...
comment on function public.kati_legacy_legal_source_content_rows(text[]) is
  'Bounded internal-only read projection for legacy content comparison; exposes structural chunk order, calculates SHA-256 in database, and never writes legal-source verification fields.';
