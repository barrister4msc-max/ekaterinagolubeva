...
Для налоговых проверок high — если есть требование ФНС со сроком ответа, акт проверки, решение о доначислении, блокировка счета, вызов в налоговую, НДС, дробление бизнеса или ст. 54.1 НК РФ.
